...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `vykaz-hospodareni` |
| **Evidence Type** | `VYKAZ_HOSPODARENI` |
| **Import Status** | DISALLOWED |
| **DB Name** | `StavyUctu` |
| **Ext ID Supported** | false |
| **API URL** | `https://demo.flexibee.eu/c/demo/vykaz-hospodareni` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/vykaz-hospodareni/properties` |
