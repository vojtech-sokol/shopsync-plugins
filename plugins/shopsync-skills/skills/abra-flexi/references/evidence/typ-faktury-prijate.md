...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `typ-faktury-prijate` |
| **Evidence Type** | `FAKTURA_IN_TYP` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `dTypDokl` |
| **Ext ID Supported** | true |
| **API URL** | `https://demo.flexibee.eu/c/demo/typ-faktury-prijate` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/typ-faktury-prijate/properties` |
...
| `radaVydej` | Dokladová řada | relation | IdRadyVydej | ne | ANO | - | - | - | `rada-faktury-prijate` | Dokladová řada |
