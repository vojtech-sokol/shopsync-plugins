...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `zavazek` |
| **Evidence Type** | `ZAVAZEK` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `dDoklFak` |
| **Ext ID Supported** | true |
| **API URL** | `https://demo.flexibee.eu/c/demo/zavazek` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/zavazek/properties` |
...
| `typDokl` | Typ závazku | relation | IdTypDokl | **ANO** | ANO | - | - | - | `typ-zavazku` | Typ závazku |
...
| `rada` | Čís. řada | relation | IdRady | ne | ANO | - | - | - | `rada-zavazku` | Čís. řada |
