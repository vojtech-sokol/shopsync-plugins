...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `stav-smlouvy` |
| **Evidence Type** | `STAV_SMLOUVY` |
| **Import Status** | SUPPORTED |
| **DB Name** | `dStavSml` |
| **Ext ID Supported** | true |
| **API URL** | `https://demo.flexibee.eu/c/demo/stav-smlouvy` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/stav-smlouvy/properties` |

## Vlastnosti (12)

| Vlastnost | Název | Typ | DB | Povinné | Zápis | Max. délka | Číslice | Des. místa | FK evidence | Popis |
|---|---|---|---|---|---|---|---|---|---|---|
| `id` | ID | integer | IdStavSml | ne | ne | - | - | - | - | ID |
