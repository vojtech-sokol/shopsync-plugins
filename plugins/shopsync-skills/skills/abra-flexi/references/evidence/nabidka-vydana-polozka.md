...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `nabidka-vydana-polozka` |
| **Evidence Type** | `NABIDKA_OUT_POLOZKA` |
| **Import Status** | NOT_DIRECT |
| **DB Name** | `dPolObch` |
| **Ext ID Supported** | true |
| **API URL** | `https://demo.flexibee.eu/c/demo/nabidka-vydana-polozka` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/nabidka-vydana-polozka/properties` |
...
| `doklObch` | Obchodní doklad | relation | IdDoklObch | ne | ne | - | - | - | `nabidka-vydana` | Obchodní doklad |
| `poplatekParentPolObch` | Poplatek k položce | relation | IdPolObchPoplatek | ne | ANO | - | - | - | `nabidka-vydana-polozka` | Poplatek k položce |
