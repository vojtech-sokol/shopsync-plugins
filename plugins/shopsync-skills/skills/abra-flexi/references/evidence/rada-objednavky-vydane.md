...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `rada-objednavky-vydane` |
| **Evidence Type** | `OBJEDNAVKA_OUT_RADA` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `dRady` |
| **Ext ID Supported** | false |
| **API URL** | `https://demo.flexibee.eu/c/demo/rada-objednavky-vydane` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/rada-objednavky-vydane/properties` |
