...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `faktura-prijata-polozka` |
| **Evidence Type** | `FAKTURA_IN_POLOZKA` |
| **Import Status** | NOT_DIRECT |
| **DB Name** | `dPolFak` |
| **Ext ID Supported** | true |
| **API URL** | `https://demo.flexibee.eu/c/demo/faktura-prijata-polozka` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/faktura-prijata-polozka/properties` |
...
| `slevaDokl` | Sleva dokladu [%] | numeric | SlevaDokl | ne | ne | - | 6 | 2 | - | Sleva dokladu [%] |
...
| `sazbaDphPuv` | Původní sazba DPH | relation | IdSazbyDphPuv | ne | ANO | - | - | - | `sazba-dph` | Původní sazba DPH |
...
| `skupPlneni` | Skupina plnění | relation | IdSkupPlneni | ne | ANO | - | - | - | `skupina-plneni` | Skupina plnění |
...
| `kopEkokom` | Kopírovat výkaz Ekokom | logic | KopEkokom | ne | ANO | - | - | - | - | Kopírovat výkaz Ekokom |
...
| `doklFak` | Doklad | relation | IdDoklFak | ne | ne | - | - | - | `faktura-prijata` | Doklad |
| `poplatekParentPolFak` | Poplatek k položce | relation | IdPolFakPoplatek | ne | ANO | - | - | - | `faktura-prijata-polozka` | Poplatek k položce |
| `zdrojProSkl` | Zdroj pro sklad. doklady | logic | ZdrojProSkl | **ANO** | ANO | - | - | - | - | Zdroj pro sklad. doklady |
| `zaloha` | Zálohová položka | logic | Zaloha | **ANO** | ANO | - | - | - | - | Zálohová položka |
