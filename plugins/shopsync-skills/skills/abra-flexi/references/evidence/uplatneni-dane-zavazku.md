# Uplatnění daně - závazky

| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `uplatneni-dane-zavazku` |
| **Evidence Type** | `UPLATNENI_DANE_ZAV` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `dDoklFak` |
| **Ext ID Supported** | true |
| **API URL** | `https://demo.flexibee.eu/c/demo/uplatneni-dane-zavazku` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/uplatneni-dane-zavazku/properties` |
...
| `typDokl` | Typ upl. daně - záv. | relation | IdTypDokl | **ANO** | ANO | - | - | - | `typ-uplatneni-dane-zavazku` | Typ upl. daně - záv. |
...
| `rada` | Čís. řada | relation | IdRady | ne | ANO | - | - | - | `rada-uplatneni-dane-zavazku` | Čís. řada |
