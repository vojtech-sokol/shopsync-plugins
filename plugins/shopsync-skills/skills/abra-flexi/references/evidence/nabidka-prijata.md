...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `nabidka-prijata` |
| **Evidence Type** | `NABIDKA_IN` |
| **Import Status** | SUPPORTED |
| **DB Name** | `dDoklObch` |
| **Ext ID Supported** | true |
| **API URL** | `https://demo.flexibee.eu/c/demo/nabidka-prijata` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/nabidka-prijata/properties` |
...
| `datObj` | Datum nabídky | date | DatObj | ne | ANO | - | - | - | - | Datum nabídky |
...
| `typDokl` | Typ dokladu | relation | IdTypDokl | **ANO** | ANO | - | - | - | `typ-nabidky-prijate` | Typ dokladu |
...
| `rada` | Čís. řada | relation | IdRady | ne | ANO | - | - | - | `rada-nabidky-prijate` | Čís. řada |
...
| `typDoklNabFak` | Typ objednávky vydané | relation | IdTypDoklNabFak | ne | ANO | - | - | - | `typ-objednavky-vydane` | Typ objednávky vydané |
