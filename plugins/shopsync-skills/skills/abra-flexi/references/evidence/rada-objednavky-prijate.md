...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `rada-objednavky-prijate` |
| **Evidence Type** | `OBJEDNAVKA_IN_RADA` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `dRady` |
| **Ext ID Supported** | false |
| **API URL** | `https://demo.flexibee.eu/c/demo/rada-objednavky-prijate` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/rada-objednavky-prijate/properties` |
