...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `rada-skladovy-pohyb` |
| **Evidence Type** | `SKLADOVY_POHYB_RADA` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `dRady` |
| **Ext ID Supported** | false |
| **API URL** | `https://demo.flexibee.eu/c/demo/rada-skladovy-pohyb` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/rada-skladovy-pohyb/properties` |
