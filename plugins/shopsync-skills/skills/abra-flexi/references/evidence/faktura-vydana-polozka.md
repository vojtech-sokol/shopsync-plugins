...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `faktura-vydana-polozka` |
| **Evidence Type** | `FAKTURA_OUT_POLOZKA` |
| **Import Status** | NOT_DIRECT |
| **DB Name** | `dPolFak` |
| **Ext ID Supported** | true |
| **API URL** | `https://demo.flexibee.eu/c/demo/faktura-vydana-polozka` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/faktura-vydana-polozka/properties` |
...
| `doklFak` | Doklad | relation | IdDoklFak | ne | ne | - | - | - | `faktura-vydana` | Doklad |
| `poplatekParentPolFak` | Poplatek k položce | relation | IdPolFakPoplatek | ne | ANO | - | - | - | `faktura-vydana-polozka` | Poplatek k položce |
