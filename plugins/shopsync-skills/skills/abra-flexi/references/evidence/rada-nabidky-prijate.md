...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `rada-nabidky-prijate` |
| **Evidence Type** | `NABIDKA_IN_RADA` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `dRady` |
| **Ext ID Supported** | false |
| **API URL** | `https://demo.flexibee.eu/c/demo/rada-nabidky-prijate` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/rada-nabidky-prijate/properties` |
