...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `pokladni-pohyb-polozka` |
| **Evidence Type** | `POKLADNI_POHYB_POLOZKA` |
| **Import Status** | NOT_DIRECT |
| **DB Name** | `dPolInt` |
| **Ext ID Supported** | true |
| **API URL** | `https://demo.flexibee.eu/c/demo/pokladni-pohyb-polozka` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/pokladni-pohyb-polozka/properties` |
...
| `doklInt` | Doklad | relation | IdDoklInt | ne | ne | - | - | - | `pokladni-pohyb` | Pokladní doklad |
| `poplatekParentPolInt` | Poplatek k položce | relation | IdPolIntPoplatek | ne | ANO | - | - | - | `pokladni-pohyb-polozka` | Poplatek k položce |
