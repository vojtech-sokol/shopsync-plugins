...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `certifikat-finbricks` |
| **Evidence Type** | `CERTIFIKAT_FINBRICKS` |
| **Import Status** | DISALLOWED |
| **DB Name** | `wOsCert` |
| **Ext ID Supported** | false |
| **API URL** | `https://demo.flexibee.eu/c/demo/certifikat-finbricks` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/certifikat-finbricks/properties` |
