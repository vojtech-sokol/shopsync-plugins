...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `objednavka-vydana-polozka` |
| **Evidence Type** | `OBJEDNAVKA_OUT_POLOZKA` |
| **Import Status** | NOT_DIRECT |
| **DB Name** | `dPolObch` |
| **Ext ID Supported** | true |
| **API URL** | `https://demo.flexibee.eu/c/demo/objednavka-vydana-polozka` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/objednavka-vydana-polozka/properties` |
...
| `doklObch` | Obchodní doklad | relation | IdDoklObch | ne | ne | - | - | - | `objednavka-vydana` | Obchodní doklad |
| `poplatekParentPolObch` | Poplatek k položce | relation | IdPolObchPoplatek | ne | ANO | - | - | - | `objednavka-vydana-polozka` | Poplatek k položce |
