...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `umisteni-ve-skladu-mistnost` |
| **Evidence Type** | `UMISTENI_VE_SKLADU_MISTNOST` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `sUmisteni` |
| **Ext ID Supported** | false |
| **API URL** | `https://demo.flexibee.eu/c/demo/umisteni-ve-skladu-mistnost` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/umisteni-ve-skladu-mistnost/properties` |
