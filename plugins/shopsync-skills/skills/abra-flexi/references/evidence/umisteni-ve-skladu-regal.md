...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `umisteni-ve-skladu-regal` |
| **Evidence Type** | `UMISTENI_VE_SKLADU_REGAL` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `sUmisteni` |
| **Ext ID Supported** | false |
| **API URL** | `https://demo.flexibee.eu/c/demo/umisteni-ve-skladu-regal` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/umisteni-ve-skladu-regal/properties` |
