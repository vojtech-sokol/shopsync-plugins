...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `castky-k-odpoctu` |
| **Evidence Type** | `CASTKY_K_ODPOCTU` |
| **Import Status** | DISALLOWED |
| **DB Name** | `CastkyKOdpoctu` |
| **Ext ID Supported** | false |
| **API URL** | `https://demo.flexibee.eu/c/demo/castky-k-odpoctu` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/castky-k-odpoctu/properties` |
