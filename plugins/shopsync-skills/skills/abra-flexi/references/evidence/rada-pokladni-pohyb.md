...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `rada-pokladni-pohyb` |
| **Evidence Type** | `POKLADNI_POHYB_RADA` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `dRady` |
| **Ext ID Supported** | false |
| **API URL** | `https://demo.flexibee.eu/c/demo/rada-pokladni-pohyb` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/rada-pokladni-pohyb/properties` |
