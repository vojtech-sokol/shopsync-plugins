...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `typ-vzajemnych-zapoctu` |
| **Evidence Type** | `VZAJEMNY_ZAPOCET_TYP` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `dTypDokl` |
| **Ext ID Supported** | true |
| **API URL** | `https://demo.flexibee.eu/c/demo/typ-vzajemnych-zapoctu` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/typ-vzajemnych-zapoctu/properties` |
