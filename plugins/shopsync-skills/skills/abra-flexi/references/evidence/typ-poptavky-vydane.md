...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `typ-poptavky-vydane` |
| **Evidence Type** | `POPTAVKA_OUT_TYP` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `dTypDokl` |
| **Ext ID Supported** | true |
| **API URL** | `https://demo.flexibee.eu/c/demo/typ-poptavky-vydane` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/typ-poptavky-vydane/properties` |
...
| `radaVydej` | Dokladová řada | relation | IdRadyVydej | ne | ANO | - | - | - | `rada-poptavky-vydane` | Dokladová řada |
