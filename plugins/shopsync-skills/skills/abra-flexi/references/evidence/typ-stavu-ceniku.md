...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `typ-stavu-ceniku` |
| **Evidence Type** | `TYP_STAVU_CENIKU` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `cStavCen` |
| **Ext ID Supported** | false |
| **API URL** | `https://demo.flexibee.eu/c/demo/typ-stavu-ceniku` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/typ-stavu-ceniku/properties` |
