...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `skupina-atributu` |
| **Evidence Type** | `SKUPINA_ATRIBUTU` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `cTypZbozi` |
| **Ext ID Supported** | false |
| **API URL** | `https://demo.flexibee.eu/c/demo/skupina-atributu` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/skupina-atributu/properties` |

## Vlastnosti (16)

| Vlastnost | Název | Typ | DB | Povinné | Zápis | Max. délka | Číslice | Des. místa | FK evidence | Popis |
|---|---|---|---|---|---|---|---|---|---|---|
| `id` | ID | integer | IdTypZbozi | ne | ne | - | - | - | - | ID |
