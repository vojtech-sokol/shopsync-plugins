...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `dodavatelska-smlouva` |
| **Evidence Type** | `DODAVATELSKA_SMLOUVA` |
| **Import Status** | SUPPORTED |
| **DB Name** | `SmlouvaView` |
| **Ext ID Supported** | true |
| **API URL** | `https://demo.flexibee.eu/c/demo/dodavatelska-smlouva` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/dodavatelska-smlouva/properties` |
...
| `typSml` | Typ smlouvy | relation | IdTypSml | **ANO** | ANO | - | - | - | `dodavatelsky-typ-smlouvy` | Typ smlouvy |
...
| `typDoklFak` | Typ faktury | relation | IdTypDokl | ne | ANO | - | - | - | `typ-faktury-prijate` | Typ faktury |
