...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `typ-faktury-vydane` |
| **Evidence Type** | `FAKTURA_OUT_TYP` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `dTypDokl` |
| **Ext ID Supported** | true |
| **API URL** | `https://demo.flexibee.eu/c/demo/typ-faktury-vydane` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/typ-faktury-vydane/properties` |
...
| `odpocAuto` | Automaticky odpočítávat | logic | OdpocAuto | ne | ANO | - | - | - | - | Povolit automatický odpočet dokladů tohoto typu |
...
| `isdocPrilohaMailu` | ISDOC v e-mailu | logic | IsdocPrilohaMailu | **ANO** | ANO | - | - | - | - | ISDOC v e-mailu |
