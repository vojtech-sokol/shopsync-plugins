...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `rozvaha-po-uctech` |
| **Evidence Type** | `ROZVAHA_PO_UCTECH` |
| **Import Status** | DISALLOWED |
| **DB Name** | `StavyUctu` |
| **Ext ID Supported** | false |
| **API URL** | `https://demo.flexibee.eu/c/demo/rozvaha-po-uctech` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/rozvaha-po-uctech/properties` |
