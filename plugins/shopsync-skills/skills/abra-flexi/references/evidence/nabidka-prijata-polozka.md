...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `nabidka-prijata-polozka` |
| **Evidence Type** | `NABIDKA_IN_POLOZKA` |
| **Import Status** | NOT_DIRECT |
| **DB Name** | `dPolObch` |
| **Ext ID Supported** | true |
| **API URL** | `https://demo.flexibee.eu/c/demo/nabidka-prijata-polozka` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/nabidka-prijata-polozka/properties` |
...
| `doklObch` | Obchodní doklad | relation | IdDoklObch | ne | ne | - | - | - | `nabidka-prijata` | Obchodní doklad |
| `poplatekParentPolObch` | Poplatek k položce | relation | IdPolObchPoplatek | ne | ANO | - | - | - | `nabidka-prijata-polozka` | Poplatek k položce |
