...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `objednavka-vydana` |
| **Evidence Type** | `OBJEDNAVKA_OUT` |
| **Import Status** | SUPPORTED |
| **DB Name** | `dDoklObch` |
| **Ext ID Supported** | true |
| **API URL** | `https://demo.flexibee.eu/c/demo/objednavka-vydana` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/objednavka-vydana/properties` |
...
| `typDokl` | Typ dokladu | relation | IdTypDokl | **ANO** | ANO | - | - | - | `typ-objednavky-vydane` | Typ dokladu |
...
| `rada` | Čís. řada | relation | IdRady | ne | ANO | - | - | - | `rada-objednavky-vydane` | Čís. řada |
...
| `typDoklNabFak` | Typ příjemky | relation | IdTypDoklNabFak | ne | ANO | - | - | - | `typ-skladovy-pohyb` | Typ příjemky |
