# Položka příkazu k úhradě

| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `prikaz-k-uhrade-polozka` |
| **Evidence Type** | `PRIKAZ_K_UHRADE_POLOZKA` |
| **Import Status** | NOT_DIRECT |
| **DB Name** | `dPolPrikazUhr` |
| **Ext ID Supported** | false |
| **API URL** | `https://demo.flexibee.eu/c/demo/prikaz-k-uhrade-polozka` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/prikaz-k-uhrade-polozka/properties` |
