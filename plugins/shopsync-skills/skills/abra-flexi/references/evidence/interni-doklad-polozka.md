...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `interni-doklad-polozka` |
| **Evidence Type** | `INTERNI_DOKLAD_POLOZKA` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `dPolInt` |
| **Ext ID Supported** | true |
| **API URL** | `https://demo.flexibee.eu/c/demo/interni-doklad-polozka` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/interni-doklad-polozka/properties` |
...
| `doklInt` | Doklad | relation | IdDoklInt | ne | ne | - | - | - | `interni-doklad` | Interní doklad |
