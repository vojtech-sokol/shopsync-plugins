...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `faktura-prijata` |
| **Evidence Type** | `FAKTURA_IN` |
| **Import Status** | SUPPORTED |
| **DB Name** | `dDoklFak` |
| **Ext ID Supported** | true |
| **API URL** | `https://demo.flexibee.eu/c/demo/faktura-prijata` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/faktura-prijata/properties` |
...
| `datVyst` | Datum přijetí | date | DatVyst | **ANO** | ANO | - | - | - | - | Přijato |
...
| `typDokl` | Typ faktury | relation | IdTypDokl | **ANO** | ANO | - | - | - | `typ-faktury-prijate` | Typ faktury |
...
| `protiUcet` | Účet MD | relation | IdProtiUcet | ne | ANO | 6 | - | - | `ucet` | Účet MD |
...
| `krajUrc` | Kraj určení | relation | IdKrajUrc | ne | ANO | - | - | - | `intrastat-kraj-urceni` | Kraj určení |
...
| `rada` | Čís. řada | relation | IdRady | ne | ANO | - | - | - | `rada-faktury-prijate` | Čís. řada |
...
| `smlouva` | Smlouva | relation | IdSmlouvy | ne | ANO | 20 | - | - | `dodavatelska-smlouva` | Smlouva |
