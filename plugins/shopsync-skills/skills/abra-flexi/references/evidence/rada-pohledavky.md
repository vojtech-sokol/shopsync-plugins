...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `rada-pohledavky` |
| **Evidence Type** | `POHLEDAVKA_RADA` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `dRady` |
| **Ext ID Supported** | false |
| **API URL** | `https://demo.flexibee.eu/c/demo/rada-pohledavky` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/rada-pohledavky/properties` |
