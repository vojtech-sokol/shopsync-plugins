...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `analyza-zakazky` |
| **Evidence Type** | `ANALYZA_ZAKAZKY` |
| **Import Status** | DISALLOWED |
| **DB Name** | `PohybyNaUctech` |
| **Ext ID Supported** | false |
| **API URL** | `https://demo.flexibee.eu/c/demo/analyza-zakazky` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/analyza-zakazky/properties` |
