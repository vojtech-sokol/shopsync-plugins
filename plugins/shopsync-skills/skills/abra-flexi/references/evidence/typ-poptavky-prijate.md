...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `typ-poptavky-prijate` |
| **Evidence Type** | `POPTAVKA_IN_TYP` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `dTypDokl` |
| **Ext ID Supported** | true |
| **API URL** | `https://demo.flexibee.eu/c/demo/typ-poptavky-prijate` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/typ-poptavky-prijate/properties` |
...
| `radaPrijem` | Dokladová řada | relation | IdRadyPrijem | ne | ANO | - | - | - | `rada-poptavky-prijate` | Dokladová řada |
