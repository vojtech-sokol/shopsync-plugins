...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `hlavni-kniha` |
| **Evidence Type** | `HLAVNI_KNIHA` |
| **Import Status** | DISALLOWED |
| **DB Name** | `ObratovaPredvaha` |
| **Ext ID Supported** | false |
| **API URL** | `https://demo.flexibee.eu/c/demo/hlavni-kniha` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/hlavni-kniha/properties` |
