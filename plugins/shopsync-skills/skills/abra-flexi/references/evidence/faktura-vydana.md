...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `faktura-vydana` |
| **Evidence Type** | `FAKTURA_OUT` |
| **Import Status** | SUPPORTED |
| **DB Name** | `dDoklFak` |
| **Ext ID Supported** | true |
| **API URL** | `https://demo.flexibee.eu/c/demo/faktura-vydana` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/faktura-vydana/properties` |
...
| `typDokl` | Typ faktury | relation | IdTypDokl | **ANO** | ANO | - | - | - | `typ-faktury-vydane` | Typ faktury |
