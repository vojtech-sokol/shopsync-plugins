...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `rada-interniho-dokladu` |
| **Evidence Type** | `INTERNI_DOKLAD_RADA` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `dRady` |
| **Ext ID Supported** | false |
| **API URL** | `https://demo.flexibee.eu/c/demo/rada-interniho-dokladu` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/rada-interniho-dokladu/properties` |
