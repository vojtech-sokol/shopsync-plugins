...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `cenikovy-pohyb-prodej` |
| **Evidence Type** | `CENIKOVE_POHYBY_PRODEJ` |
| **Import Status** | DISALLOWED |
| **DB Name** | `CenikovePohyby` |
| **Ext ID Supported** | false |
| **API URL** | `https://demo.flexibee.eu/c/demo/cenikovy-pohyb-prodej` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/cenikovy-pohyb-prodej/properties` |
