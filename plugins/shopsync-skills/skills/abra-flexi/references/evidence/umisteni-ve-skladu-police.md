...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `umisteni-ve-skladu-police` |
| **Evidence Type** | `UMISTENI_VE_SKLADU_POLICE` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `sUmisteni` |
| **Ext ID Supported** | false |
| **API URL** | `https://demo.flexibee.eu/c/demo/umisteni-ve-skladu-police` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/umisteni-ve-skladu-police/properties` |
