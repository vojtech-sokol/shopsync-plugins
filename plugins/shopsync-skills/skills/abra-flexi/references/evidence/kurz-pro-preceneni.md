...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `kurz-pro-preceneni` |
| **Evidence Type** | `KURZ_PRO_PRECENENI` |
| **Import Status** | DISALLOWED |
| **DB Name** | `uKurzy` |
| **Ext ID Supported** | true |
| **API URL** | `https://demo.flexibee.eu/c/demo/kurz-pro-preceneni` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/kurz-pro-preceneni/properties` |
