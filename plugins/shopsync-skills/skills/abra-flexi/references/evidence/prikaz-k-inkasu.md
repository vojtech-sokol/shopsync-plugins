...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `prikaz-k-inkasu` |
| **Evidence Type** | `PRIKAZ_K_INKASU` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `dPrikazUhr` |
| **Ext ID Supported** | false |
| **API URL** | `https://demo.flexibee.eu/c/demo/prikaz-k-inkasu` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/prikaz-k-inkasu/properties` |
