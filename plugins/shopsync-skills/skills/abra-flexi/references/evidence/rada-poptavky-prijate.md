...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `rada-poptavky-prijate` |
| **Evidence Type** | `POPTAVKA_IN_RADA` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `dRady` |
| **Ext ID Supported** | false |
| **API URL** | `https://demo.flexibee.eu/c/demo/rada-poptavky-prijate` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/rada-poptavky-prijate/properties` |
