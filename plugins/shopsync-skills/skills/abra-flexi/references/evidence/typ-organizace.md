...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `typ-organizace` |
| **Evidence Type** | `TYP_ORGANIZACE` |
| **Import Status** | DISALLOWED |
| **DB Name** | `uTypOrg` |
| **Ext ID Supported** | false |
| **API URL** | `https://demo.flexibee.eu/c/demo/typ-organizace` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/typ-organizace/properties` |

## Vlastnosti (12)

| Vlastnost | Název | Typ | DB | Povinné | Zápis | Max. délka | Číslice | Des. místa | FK evidence | Popis |
|---|---|---|---|---|---|---|---|---|---|---|
| `id` | ID | integer | IdTypOrg | ne | ne | - | - | - | - | ID |
