...
| **API URL** | `https://demo.flexibee.eu/c/demo/banka` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/banka/properties` |
...
| `typDokl` | Typ dokladu | relation | IdTypDokl | **ANO** | ANO | - | - | - | `typ-banka` | Typ dokladu |
| `banka` | Bank.účet | relation | IdBsp | **ANO** | ANO | - | - | - | `bankovni-ucet` | Bank.účet |
