...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `dodavatelsky-typ-smlouvy` |
| **Evidence Type** | `DODAVATELSKY_TYP_SMLOUVY` |
| **Import Status** | SUPPORTED |
| **DB Name** | `dTypSml` |
| **Ext ID Supported** | true |
| **API URL** | `https://demo.flexibee.eu/c/demo/dodavatelsky-typ-smlouvy` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/dodavatelsky-typ-smlouvy/properties` |
