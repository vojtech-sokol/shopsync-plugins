...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `vysledovka-po-uctech` |
| **Evidence Type** | `VYSLEDOVKA_PO_UCTECH` |
| **Import Status** | DISALLOWED |
| **DB Name** | `StavyUctu` |
| **Ext ID Supported** | false |
| **API URL** | `https://demo.flexibee.eu/c/demo/vysledovka-po-uctech` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/vysledovka-po-uctech/properties` |
