...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `typ-nabidky-prijate` |
| **Evidence Type** | `NABIDKA_IN_TYP` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `dTypDokl` |
| **Ext ID Supported** | true |
| **API URL** | `https://demo.flexibee.eu/c/demo/typ-nabidky-prijate` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/typ-nabidky-prijate/properties` |
...
| `radaVydej` | Dokladová řada | relation | IdRadyVydej | ne | ANO | - | - | - | `rada-nabidky-prijate` | Dokladová řada |
