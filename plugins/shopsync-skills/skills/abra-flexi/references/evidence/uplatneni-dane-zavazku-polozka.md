# Položky uplatnění daně - závazky

| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `uplatneni-dane-zavazku-polozka` |
| **Evidence Type** | `UPLATNENI_DANE_ZAV_POLOZKA` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `dPolFak` |
| **Ext ID Supported** | true |
| **API URL** | `https://demo.flexibee.eu/c/demo/uplatneni-dane-zavazku-polozka` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/uplatneni-dane-zavazku-polozka/properties` |
...
| `doklFak` | Doklad | relation | IdDoklFak | ne | ne | - | - | - | `uplatneni-dane-zavazku` | Doklad |
