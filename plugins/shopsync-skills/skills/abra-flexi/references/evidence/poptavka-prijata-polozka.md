...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `poptavka-prijata-polozka` |
| **Evidence Type** | `POPTAVKA_IN_POLOZKA` |
| **Import Status** | NOT_DIRECT |
| **DB Name** | `dPolObch` |
| **Ext ID Supported** | true |
| **API URL** | `https://demo.flexibee.eu/c/demo/poptavka-prijata-polozka` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/poptavka-prijata-polozka/properties` |
...
| `doklObch` | Obchodní doklad | relation | IdDoklObch | ne | ne | - | - | - | `poptavka-prijata` | Obchodní doklad |
| `poplatekParentPolObch` | Poplatek k položce | relation | IdPolObchPoplatek | ne | ANO | - | - | - | `poptavka-prijata-polozka` | Poplatek k položce |
