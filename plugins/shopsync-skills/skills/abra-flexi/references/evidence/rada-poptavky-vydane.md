...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `rada-poptavky-vydane` |
| **Evidence Type** | `POPTAVKA_OUT_RADA` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `dRady` |
| **Ext ID Supported** | false |
| **API URL** | `https://demo.flexibee.eu/c/demo/rada-poptavky-vydane` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/rada-poptavky-vydane/properties` |
