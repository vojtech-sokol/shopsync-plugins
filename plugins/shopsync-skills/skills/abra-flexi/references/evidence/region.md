...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `region` |
| **Evidence Type** | `REGION` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `aRegion` |
| **Ext ID Supported** | false |
| **API URL** | `https://demo.flexibee.eu/c/demo/region` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/region/properties` |

## Vlastnosti (16)

| Vlastnost | Název | Typ | DB | Povinné | Zápis | Max. délka | Číslice | Des. místa | FK evidence | Popis |
|---|---|---|---|---|---|---|---|---|---|---|
| `id` | ID | integer | IdRegion | ne | ne | - | - | - | - | ID |
