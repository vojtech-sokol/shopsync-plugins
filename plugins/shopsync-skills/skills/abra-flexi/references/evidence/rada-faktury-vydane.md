...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `rada-faktury-vydane` |
| **Evidence Type** | `FAKTURA_OUT_RADA` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `dRady` |
| **Ext ID Supported** | false |
| **API URL** | `https://demo.flexibee.eu/c/demo/rada-faktury-vydane` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/rada-faktury-vydane/properties` |
