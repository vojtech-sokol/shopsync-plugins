# Neuhrazené po splatnosti

| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `neuhrazene-po-splatnosti` |
| **Evidence Type** | `NEUHRAZENE_PO_SPLATNOSTI` |
| **Import Status** | DISALLOWED |
| **DB Name** | `NeuhrazenePoSplatnosti` |
| **Ext ID Supported** | false |
| **API URL** | `https://demo.flexibee.eu/c/demo/neuhrazene-po-splatnosti` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/neuhrazene-po-splatnosti/properties` |
