...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `rada-nabidky-vydane` |
| **Evidence Type** | `NABIDKA_OUT_RADA` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `dRady` |
| **Ext ID Supported** | false |
| **API URL** | `https://demo.flexibee.eu/c/demo/rada-nabidky-vydane` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/rada-nabidky-vydane/properties` |
