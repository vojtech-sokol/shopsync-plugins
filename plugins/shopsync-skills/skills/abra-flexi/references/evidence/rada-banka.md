...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `rada-banka` |
| **Evidence Type** | `BANKA_RADA` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `dRady` |
| **Ext ID Supported** | false |
| **API URL** | `https://demo.flexibee.eu/c/demo/rada-banka` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/rada-banka/properties` |
