...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `poptavka-prijata` |
| **Evidence Type** | `POPTAVKA_IN` |
| **Import Status** | SUPPORTED |
| **DB Name** | `dDoklObch` |
| **Ext ID Supported** | true |
| **API URL** | `https://demo.flexibee.eu/c/demo/poptavka-prijata` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/poptavka-prijata/properties` |
...
| `datObj` | Poptáno | date | DatObj | ne | ANO | - | - | - | - | Poptáno |
...
| `typDokl` | Typ dokladu | relation | IdTypDokl | **ANO** | ANO | - | - | - | `typ-poptavky-prijate` | Typ dokladu |
...
| `rada` | Čís. řada | relation | IdRady | ne | ANO | - | - | - | `rada-poptavky-prijate` | Čís. řada |
...
| `typDoklNabFak` | Vytvořit nabídku typu ... | relation | IdTypDoklNabFak | ne | ANO | - | - | - | `typ-nabidky-vydane` | Vytvořit nabídku typu ... |
