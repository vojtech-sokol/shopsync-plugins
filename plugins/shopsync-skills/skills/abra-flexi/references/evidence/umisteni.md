...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `umisteni` |
| **Evidence Type** | `UMISTENI` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `mUmisteni` |
| **Ext ID Supported** | true |
| **API URL** | `https://demo.flexibee.eu/c/demo/umisteni` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/umisteni/properties` |
