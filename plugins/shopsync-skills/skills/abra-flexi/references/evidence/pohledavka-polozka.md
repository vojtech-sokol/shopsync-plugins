...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `pohledavka-polozka` |
| **Evidence Type** | `POHLEDAVKA_POLOZKA` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `dPolFak` |
| **Ext ID Supported** | true |
| **API URL** | `https://demo.flexibee.eu/c/demo/pohledavka-polozka` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/pohledavka-polozka/properties` |
...
| `doklFak` | Doklad | relation | IdDoklFak | ne | ne | - | - | - | `pohledavka` | Doklad |
