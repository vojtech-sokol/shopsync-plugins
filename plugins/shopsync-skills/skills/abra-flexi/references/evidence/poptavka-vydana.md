...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `poptavka-vydana` |
| **Evidence Type** | `POPTAVKA_OUT` |
| **Import Status** | SUPPORTED |
| **DB Name** | `dDoklObch` |
| **Ext ID Supported** | true |
| **API URL** | `https://demo.flexibee.eu/c/demo/poptavka-vydana` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/poptavka-vydana/properties` |
...
| `typDokl` | Typ dokladu | relation | IdTypDokl | **ANO** | ANO | - | - | - | `typ-poptavky-vydane` | Typ dokladu |
...
| `rada` | Čís. řada | relation | IdRady | ne | ANO | - | - | - | `rada-poptavky-vydane` | Čís. řada |
...
| `typDoklNabFak` | Typ nabídky přijaté | relation | IdTypDoklNabFak | ne | ANO | - | - | - | `typ-nabidky-prijate` | Typ nabídky přijaté |
