...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `rada-zavazku` |
| **Evidence Type** | `ZAVAZEK_RADA` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `dRady` |
| **Ext ID Supported** | false |
| **API URL** | `https://demo.flexibee.eu/c/demo/rada-zavazku` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/rada-zavazku/properties` |
