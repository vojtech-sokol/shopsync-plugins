...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `bankovni-ucet-pokladna` |
| **Evidence Type** | `BANKOVNI_UCET_POKLADNA` |
| **Import Status** | DISALLOWED |
| **DB Name** | `dBsp` |
| **Ext ID Supported** | true |
| **API URL** | `https://demo.flexibee.eu/c/demo/bankovni-ucet-pokladna` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/bankovni-ucet-pokladna/properties` |
