...
| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `typ-objednavky-vydane` |
| **Evidence Type** | `OBJEDNAVKA_OUT_TYP` |
| **Import Status** | NOT_DOCUMENTED |
| **DB Name** | `dTypDokl` |
| **Ext ID Supported** | true |
| **API URL** | `https://demo.flexibee.eu/c/demo/typ-objednavky-vydane` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/typ-objednavky-vydane/properties` |
...
| `radaVydej` | Dokladová řada | relation | IdRadyVydej | ne | ANO | - | - | - | `rada-objednavky-vydane` | Dokladová řada |
...
| `typDoklFak` | Typ přijaté faktury | relation | IdTypDoklFak | ne | ANO | - | - | - | `typ-faktury-prijate` | Typ přijaté faktury |
