# Neuhrazené po splatnosti - uhrazené

| Vlastnost | Hodnota |
|---|---|
| **Evidence Path** | `neuhrazene-po-splatnosti-2` |
| **Evidence Type** | `NEUHRAZENE_PO_SPLATNOSTI_2` |
| **Import Status** | DISALLOWED |
| **DB Name** | `NeuhrazenePoSplatnosti2` |
| **Ext ID Supported** | false |
| **API URL** | `https://demo.flexibee.eu/c/demo/neuhrazene-po-splatnosti-2` |
| **Properties URL** | `https://demo.flexibee.eu/c/demo/neuhrazene-po-splatnosti-2/properties` |

## Vlastnosti (141)

| Vlastnost | Název | Typ | DB | Povinné | Zápis | Max. délka | Číslice | Des. místa | FK evidence | Popis |
|---|---|---|---|---|---|---|---|---|---|---|
| `idPoSplatnosti` | ID po splatnosti | numeric |  | ne | ANO | - | - | - | - | ID po splatnosti |
| `idDokl` | ID dokladu | numeric |  | ne | ANO | - | - | - | - | ID dokladu |
...
| `typPohybuK` | Typ pohybu | select |  | ne | ANO | 50 | - | - | - | Typ pohybu |
...
| `dphSnizKoef` | Snížená DPH koeficientem | logic |  | ne | ANO | - | - | - | - | Snížená DPH koeficientem |
| `dphZaklKoef` | Základní DPH koeficientem | logic |  | ne | ANO | - | - | - | - | Základní DPH koeficientem |
...
| `bsp` | Banka/pokladna/sklad | relation |  | ne | ANO | - | - | - | `bankovni-ucet-sklad-pokladna` | Banka/pokladna/sklad |
...
| `subModul` | Submodul | logic |  | ne | ANO | - | - | - | - | Submodul |
...
| `vraceniDph` | Vrácení DPH | logic |  | ne | ANO | - | - | - | - | Vrácení DPH |
| `obnovaDph` | Obnova DPH | logic |  | ne | ANO | - | - | - | - | Obnova DPH |
| `radekKraceniDph` | Řádek krácení DPH | logic |  | ne | ANO | - | - | - | - | Řádek krácení DPH |
| `pouzitRadekKraceniDph` | Použít řádek krácení DPH | logic |  | ne | ANO | - | - | - | - | Použít řádek krácení DPH |
| `vyzadujeKoeficient` | Vyžaduje koeficient | logic |  | ne | ANO | - | - | - | - | Vyžaduje koeficient |
| `kodUhrady` | Kód úhrady | string |  | ne | ANO | - | - | - | - | Kód úhrady |
| `castkaVazby` | Částka úhrady | numeric |  | ne | ANO | - | - | - | - | Částka úhrady |
| `uhrada` | Úhrada | relation |  | ne | ANO | - | - | - | `interni-doklad` | Úhrada |
| `dokladOpravaDph` | Doklady opravující DPH | relation |  | ne | ANO | - | - | - | - | Doklady opravující DPH |
| `doklFak` | Doklad faktury | relation |  | ne | ANO | - | - | - | - | Doklad faktury |
